...
import { GraduationCap, MapPin, Phone, Mail, Instagram, Facebook, Twitter, Linkedin, BookOpen, Users, Award, Shield, MessageCircle } from "lucide-react";
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="https://wa.me/919709920220" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:contact@mentoraonline.guru" className="hover:text-white transition">

                  contact@mentoraonline.guru
            ...
            <div className="mt-4 flex gap-3">
              ...
              <a
                ...
                href="https://instagram.com/mentoraa.ai"
